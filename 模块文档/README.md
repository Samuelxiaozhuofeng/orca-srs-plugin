...
27. **[渐进阅读_低压体验优化计划.md](渐进阅读_低压体验优化计划.md)** — **计划文档**（顶部有落地对照）
28. **[渐进阅读_优化路线.md](渐进阅读_优化路线.md)** — **计划/路线**（顶部有状态对照）

### AI

29. **[SRS_AI模块.md](SRS_AI模块.md)** — Plan B：单次生成最终草稿、本地校验、预览确认与分组写入
30. **[AI智能制卡使用指南.md](AI智能制卡使用指南.md)** — AI 生成闪卡使用向导
31. **[AI_API_404错误排查指南.md](AI_API_404错误排查指南.md)** — 排查类

### 协作与历史

32. **[仓库贡献指南.md](仓库贡献指南.md)** — 构建与模块文档同步规范
33. **[React集成问题修复报告.md](React集成问题修复报告.md)** — 历史报告
34. **[问题经验.md](问题经验.md)** — 经验摘录
